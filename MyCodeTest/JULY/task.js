...
/******* Start Your Code *********/
  ...
  $two=2;
  if ($one>$two){
    console.log('The Larg Number is '+$one)
  }else{
    console.log('The Larg Number is '+$two)
  }
...
/******* Start Your Code *********/
 ...
 $secound=5;
 $theard=-1;
 if ($first>$secound&&$first>$theard){
    if($secound>$theard){
        console.log($first+" "+$secound+" "+$theard )
    }else{
        console.log($first+" "+$theard+" "+$secound )
    }
 }  else if($secound>$first&&$secound>$theard){
    if($first>$theard){
        console.log($secound+" "+$first+" "+$theard )
    }else{
        console.log($secound+" "+$theard+" "+$first )
    }
 }else if($theard>$first&&$theard>$secound){
    if($secound>$first){
        console.log($theard+" "+ $secound+" "+$first)
    }else{
        console.log($theard+" "+$secound+" "+$first )
    }
 }
...
console.log(repeatChar("schOooOl","o"))
...
$new+=str[$i].toLowerCase()
          }else{
            $new+=str[$i].toUpperCase()
          }
